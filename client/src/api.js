...
export const api = {
  ...
  moveQuestion: (qId, direction) => request(`/api/questions/${qId}/move`, { method: 'POST', body: JSON.stringify({ direction }) }),
  ...
  submitPicks: (picks, checklistQuestionIds) => request('/api/picks', { method: 'POST', body: JSON.stringify({ picks, checklist_question_ids: checklistQuestionIds }) }),
